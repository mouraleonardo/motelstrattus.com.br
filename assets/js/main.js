...
(function ($) {
  ...
  document.querySelectorAll('.slide__menu__item').forEach(function(link) {
        link.addEventListener('click', function () {
        // Verifica se o offcanvas está aberto
        var offcanvasEl = document.querySelector('#offcanvasRight.offcanvas.show');
        if (offcanvasEl) {
